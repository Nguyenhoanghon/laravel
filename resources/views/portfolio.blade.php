...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="public/portfolio/assets/favicon.ico" />
        ...
        <link href="public/portfolio/css/styles.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        ...
        <!-- Core theme JS-->
        <script src="public/portfolio/js/scripts.js"></script>
    </body>
</html>
